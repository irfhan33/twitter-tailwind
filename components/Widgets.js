...
const Widgets = ({ trendingResults, followResults }) => {
  return (
    <div className="hidden lg:inline grow min-w-[350px]">
      <div className="sticky top-0 py-2 z-50 px-4 space-y-6">
        <div className="flex items-center bg-[#202327] p-3 rounded-full relative w-full">
